...
contract PredictionBuilder {
    ...
    function _buildPrediction(address erc20, uint40 expiration, uint96 strikeAmount, uint96 predictedAmount, address _oracle)
        internal
        pure
        returns (Predicter.Prediction memory pred)
    {
        ...
        pred.predictedPrice = OracleData({oracle: _oracle, amount: predictedAmount});
