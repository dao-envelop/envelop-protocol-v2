...
contract WNFTV2Envelop721_Test_a_12 is Test {
    ...
    function test_execWithSignature_1() public {
        bytes32 pureDigest = wnft.getDigestForSign(
            ...
            0, // ether value
            abi.encodeWithSignature("transfer(address,uint256)", userEOA, sendERC20Amount / 2), //data
            userEOA
        );
        ...
        wnft.executeEncodedTxBySignature(
            ...
            abi.encodeWithSignature(
                ...
                userEOA,
                sendERC20Amount / 4 // changed value mismatching with pureDigest
            ), //data
            botSignature
        );
    }
    ...
    function test_execTX_1() public {
        bytes memory _dataLayer1 =
            abi.encodeWithSignature("transfer(address,uint256)", address(11), sendERC20Amount / 2);

        bytes memory _dataLayer2 =
            abi.encodeWithSignature("executeEncodedTx(address,uint256,bytes)", address(erc20), 0, _dataLayer1);
    ...
    function test_execWithSignature_5() public {
        ...
        bytes memory _dataLayer2 = abi.encodeWithSignature(
            "executeEncodedTxBySignature(address,uint256,bytes,bytes)", address(erc20), 0, _dataLayer1, signature1
        );
