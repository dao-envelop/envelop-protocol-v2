...
contract WNFTV2Envelop721_Test_a_11 is Test {
    ...
    function test_create_wNFT() public {
        ...
        emit WNFTV2Envelop721.EnvelopWrappedV2(
            address(this), impl_legacy.TOKEN_ID(), bytes2(uint16(uint256(hashedParams[0]))), ""
        );
        ...
        vm.expectRevert(abi.encodeWithSelector(WNFTV2Envelop721.WnftRuleViolation.selector, bytes2(0x0004)));
    ...
    function test_notDelegated() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(WNFTV2Envelop721.NoDelegateCall.selector));
