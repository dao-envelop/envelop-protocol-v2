 ...
 */
abstract contract Singleton721Light is Initializable, IERC721, IERC721Metadata, IERC721Errors, IERC4906 {
    ...
    function __ERC721_init(
        ...
        __ERC721_init_unchained(name_, symbol_, _creator, _tokenUrl);
    }
     ...
     * !!! Refactored OZ code
     */
    function balanceOf(address owner) public view virtual returns (uint256 b) {
        ERC721Storage storage $ = _getERC721Storage();
        if (owner == address(0)) {
